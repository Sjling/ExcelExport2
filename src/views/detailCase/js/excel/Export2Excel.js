...
const export_table_to_excel = function(id) {
...
const export_json_to_excel = function({
                                         title,
                                         multiHeader = [],
                                         header,
                                         data,
    ...
    //设置主标题样式
    let titlearr = ["A2", "B2", "C2", "D2", "E2", "F2", "G2", "H2", "I2", "J2", "K2", "L2", "M2", "N2", "O2", "P2", "Q2", "R2", "S2", "T2", "U2", "V2", "W2", "X2", "Y2", "Z2"];
    for(let i in dataInfo){
        if (titlearr.indexOf(i) !== -1) {
            dataInfo[i].s.font = {
                name: '宋体',
                sz: 14,
                color: {rgb: "000000"},
            ...
            dataInfo[i].s.alignment = {horizontal: "center", vertical: "center"};
        }
    }
    var wbout = XLSX.write(wb, {
        bookType: bookType,
